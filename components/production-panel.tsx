    ...
    <div className="flex flex-col gap-3">
      ...
      <div className="grid grid-cols-3 gap-2">
        <div className="industrial-card p-3 text-center">
          <div className="label-industrial mb-0.5">Previsao</div>
        ...
        <div className="industrial-card p-3 text-center">
          <div className="label-industrial mb-0.5 flex items-center justify-center gap-1">
            <TrendingUp size={9} /> Ritmo
          </div>
        ...
        <div className="industrial-card p-3 text-center">
          ...
          <div className={`font-mono text-lg font-bold ${oeeColor}`}>
            {oee.toFixed(1)}%
          </div>
          <div className="text-[9px] text-muted-foreground font-mono">
            eficiencia
      ...
      <div className="grid grid-cols-2 gap-2">
        <div className="industrial-card p-3">
          <div className="label-industrial flex items-center gap-1">
            <Target size={9} /> Producao
          </div>
          <div className="font-mono text-xl font-bold text-success mt-0.5">
            {produzida}
          </div>
          <div className="text-[9px] text-muted-foreground font-mono">
            de {state.meta} ({restante} restam)
          </div>
        </div>
        <div className="industrial-card p-3">
          <div className="label-industrial">Consumo Farinha</div>
          <div className="font-mono text-xl font-bold text-warning mt-0.5">
      ...
      <div className="industrial-card p-3 space-y-2">
        <div className="label-industrial mb-1">Parametros</div>
        ...
        <div className="grid grid-cols-3 gap-2">
          ...
          <div>
            <label className="label-industrial text-[9px]">Ritmo Max</label>
            <input
              type="number"
              className="input-industrial w-full mt-0.5 py-1.5 text-xs"
        ...
        <div className="grid grid-cols-4 gap-2">
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                setField("contagemInicial", Number(e.target.value))
              }
            />
          </div>
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                setField("contagemAtual", Number(e.target.value))
              }
            />
          </div>
          <div>
            <label className="label-industrial text-[9px] flex items-center gap-0.5">
              <Clock size={8} /> Inicio
            </label>
            <input
              type="time"
          ...
          <div>
            <label className="label-industrial text-[9px]">Almoco</label>
            <input
              type="number"
              className="input-industrial w-full mt-0.5 py-1.5 text-xs"
              value={state.almocoMinutos}
              onChange={(e) =>
                setField("almocoMinutos", Number(e.target.value))
              }
              placeholder="min"
            />
          </div>
