...
interface FlowDiagramProps {
  ...
  setTransfer: (updates: Partial<import("@/hooks/useMillControl").TransferConfig>) => void;
}

export const FlowDiagram = ({ state, setSiloAtual, setTransfer }: FlowDiagramProps) => {
              ...
              return transfer.destinos.map((dest) => {
                ...
                return (
                  <line
                    ...
                    x2={pmPos.x}
                    y2={pmPos.y}
                    stroke={isPaused ? "hsl(38,92%,50%)" : "hsl(199,89%,48%)"}
                    strokeWidth="2"
